...
{
    public partial class hastakabul_hastalistesi : Form
    {
        public hastakabul_hastalistesi()
        {
            InitializeComponent();
        }
        ...
        {
            hastakabul_hastalistesi_yenikayit yeni = new hastakabul_hastalistesi_yenikayit();
            yeni.Show();
        }

        private void button2_Click(object sender, EventArgs e)
        {
            hastakabul_hastalistesi_duzenle ahd = new hastakabul_hastalistesi_duzenle();
        ...
        private void hastakabul_hastalistesi_Load(object sender, EventArgs e)
        {
        ...
        {
            hastakabul_mail yeni = new hastakabul_mail();
            yeni.Show();
        }

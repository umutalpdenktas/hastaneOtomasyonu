...
{
    public partial class hastakabul_hastalistesi_yenikayit : Form
    {
        public hastakabul_hastalistesi_yenikayit()
        {
            InitializeComponent();
        }
        ...
        private void hastakabul_hastalistesi_yenikayit_Load(object sender, EventArgs e)
        {

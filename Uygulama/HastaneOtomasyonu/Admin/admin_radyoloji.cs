...
{
    public partial class admin_radyoloji : Form
    {
        public admin_radyoloji()
        {
            InitializeComponent();
        }
        ...
        private void admin_radyoloji_Load(object sender, EventArgs e)
        {
            sonuccek();
            adsoyad();
        ...
        {
            admin_radyoloji_gi argi = new admin_radyoloji_gi();
            argi.Show();
        }
    }
}

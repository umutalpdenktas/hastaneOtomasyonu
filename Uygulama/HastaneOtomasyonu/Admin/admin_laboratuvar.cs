...
{
    public partial class admin_laboratuvar : Form
    {
        public admin_laboratuvar()
        {
            InitializeComponent();
        }
        ...
        {
            baglanti.Open();
            komut = new SqlCommand("SELECT hasta_adsoyad FROM hasta_sonuclar", baglanti);
            dr = komut.ExecuteReader();
            if (dr.Read())
            {
                adisoyad = dr["hasta_adsoyad"].ToString();
            }
            baglanti.Close();
        }
        ...
        private void admin_laboratuvar_Load(object sender, EventArgs e)
        {
            adsoyad();
            sonuccek();
        ...
        {
            admin_laboratuvar_gi ad = new admin_laboratuvar_gi();
            ad.Show();
        }

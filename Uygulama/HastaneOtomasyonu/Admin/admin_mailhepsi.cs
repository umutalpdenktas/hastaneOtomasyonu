...
{
    public partial class admin_mailhepsi : Form
    {
        public admin_mailhepsi()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            string veri = "";
            baglanti2.Open();
            komut2 = new SqlCommand("SELECT * FROM admin", baglanti2);
            SqlDataReader dr2;
            dr2 = komut2.ExecuteReader();
            if (dr2.Read())
            {
                ad = dr2["admin_ad"].ToString() + " " + dr2["admin_soyad"].ToString();
            }
            baglanti.Close();
        ...
        {
            // TODO: Bu kod satırı 'hastane_otomasyonu_yDataSet2.doktor' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.doktorTableAdapter1.Fill(this.hastane_otomasyonu_yDataSet2.doktor);

...
{
    public partial class admin_doktor_dermatoloji : Form
    {

        public admin_doktor_dermatoloji()
        {
            InitializeComponent();
        }
        ...
        private void admin_doktor_dermatoloji_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            admin_doktor_dermatoloji_gh gh = new admin_doktor_dermatoloji_gh();
            gh.Show();
        }

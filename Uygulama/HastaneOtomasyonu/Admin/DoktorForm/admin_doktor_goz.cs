...
{
    public partial class admin_doktor_goz : Form
    {

        public admin_doktor_goz()
        {
            InitializeComponent();
        }
        ...
        private void admin_doktor_goz_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            admin_doktor_goz_gh gh = new admin_doktor_goz_gh();
            gh.Show();
        }

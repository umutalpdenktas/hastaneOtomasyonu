...
{
    public partial class admin_doktor_kardiyoloji : Form
    {

        public admin_doktor_kardiyoloji()
        {
            InitializeComponent();
        }
        ...
        private void admin_doktor_kardiyoloji_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            admin_doktor_kardiyoloji_gh gh = new admin_doktor_kardiyoloji_gh();
            gh.Show();
        }

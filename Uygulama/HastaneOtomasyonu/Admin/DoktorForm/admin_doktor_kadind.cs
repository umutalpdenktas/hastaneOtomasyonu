...
{
    public partial class admin_doktor_kadind : Form
    {

        public admin_doktor_kadind()
        {
            InitializeComponent();
        }
        ...
        private void doktorgel()
        {
            ...
            komut.Parameters.AddWithValue("@bolum", 7);
        ...
        private void admin_doktor_kadind_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    baglanti.Open();
                    komut = new SqlCommand("UPDATE hasta_sonuclar SET hasta_ad=@adsoyad,laboratuvar_tetkikler_id = @ltetkik,laboratuvar_tetkik_adi=@tad,sonuc=1 WHERE hasta_id=@hasta_id", baglanti);
                    komut.Parameters.AddWithValue("@hasta_id", textBox1.Text);
        ...
        {
            admin_doktor_kadind_gh gh = new admin_doktor_kadind_gh();
            gh.Show();
        }

...
{
    public partial class admin_doktor_dermatoloji_gh : Form
    {
        public admin_doktor_dermatoloji_gh()
        {
            InitializeComponent();
        }
        ...
        private void admin_doktor_dermatoloji_gh_Load(object sender, EventArgs e)
        {

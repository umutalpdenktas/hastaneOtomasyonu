...
{
    public partial class admin_doktor_ftr : Form
    {

        public admin_doktor_ftr()
        {
            InitializeComponent();
        }
        ...
        private void doktorgel()
        {
            ...
            komut.Parameters.AddWithValue("@bolum", 4);
        ...
        private void admin_doktor_ftr_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            admin_doktor_ftr_gh gh = new admin_doktor_ftr_gh();
            gh.Show();
        }

...
{
    public partial class admin_doktor_noroloji : Form
    {

        public admin_doktor_noroloji()
        {
            InitializeComponent();
        }
        ...
        private void admin_doktor_noroloji_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            admin_doktor_noroloji_gh gh = new admin_doktor_noroloji_gh();
            gh.Show();
        }

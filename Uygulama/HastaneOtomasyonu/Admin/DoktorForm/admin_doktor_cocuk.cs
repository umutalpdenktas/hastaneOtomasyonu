...
{
    public partial class admin_doktor_cocuk : Form
    {

        public admin_doktor_cocuk()
        {
            InitializeComponent();
        }
        ...
        private void doktorgel()
        {
            ...
            komut.Parameters.AddWithValue("@bolum", 5);
        ...
        private void admin_doktor_cocuk_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    baglanti.Open();
                    komut = new SqlCommand("UPDATE hasta_muayene SET doktor_id=5,hasta_sikayet=@sikayet,hasta_anamnez=@anamnez,hasta_ozgecmis=@ozgecmis,hasta_soygecmis=@soygecmis,hasta_kulilac=@kulilac,hasta_muayenebulgulari=@mbulgulari,hasta_oneri=@oneri,hasta_karar=@karar,hasta_teshisler=@teshisler,hasta_uyarimesaj=@uyarimesaj,hasta_tedaviadi=@hasta_tedavi, hasta_ameliyat_durumu=@hameliyat WHERE hasta_id=@hastaid", baglanti);
        ...
        {
            admin_doktor_cocuk_gh gh = new admin_doktor_cocuk_gh();
            gh.Show();
        }

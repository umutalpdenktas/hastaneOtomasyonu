...
{
    public partial class admin_doktor_ortopedi : Form
    {

        public admin_doktor_ortopedi()
        {
            InitializeComponent();
        }
        ...
        private void admin_doktor_ortopedi_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            admin_doktor_ortopedi_gh gh = new admin_doktor_ortopedi_gh();
            gh.Show();
        }

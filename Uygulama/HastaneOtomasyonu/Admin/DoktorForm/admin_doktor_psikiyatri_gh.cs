...
{
    public partial class admin_doktor_psikiyatri_gh : Form
    {
        public admin_doktor_psikiyatri_gh()
        {
            InitializeComponent();
        }
        ...
        private void admin_doktor_psikiyatri_gh_Load(object sender, EventArgs e)
        {

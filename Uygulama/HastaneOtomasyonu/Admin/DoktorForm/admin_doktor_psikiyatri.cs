...
{
    public partial class admin_doktor_psikiyatri : Form
    {

        public admin_doktor_psikiyatri()
        {
            InitializeComponent();
        }
        ...
        private void admin_doktor_psikiyatri_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            admin_doktor_psikiyatri_gh gh = new admin_doktor_psikiyatri_gh();
            gh.Show();
        }

...
{
    public partial class admin_doktor_kbb : Form
    {

        public admin_doktor_kbb()
        {
            InitializeComponent();
        }
        ...
        private void doktorgel()
        {
            ...
            komut.Parameters.AddWithValue("@bolum", 10);
        ...
        private void admin_doktor_kbb_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            admin_doktor_kbb_gh gh = new admin_doktor_kbb_gh();
            gh.Show();
        }

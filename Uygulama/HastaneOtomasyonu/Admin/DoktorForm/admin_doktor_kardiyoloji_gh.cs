...
{
    public partial class admin_doktor_kardiyoloji_gh : Form
    {
        public admin_doktor_kardiyoloji_gh()
        {
            InitializeComponent();
        }
        ...
        private void admin_doktor_noroloji_gh_Load(object sender, EventArgs e)
        {

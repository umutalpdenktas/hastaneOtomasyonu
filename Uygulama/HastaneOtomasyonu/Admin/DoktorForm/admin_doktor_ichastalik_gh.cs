...
{
    public partial class admin_doktor_ichastalik_gh : Form
    {
        public admin_doktor_ichastalik_gh()
        {
            InitializeComponent();
        }
        ...
        private void admin_doktor_ichastalik_gh_Load(object sender, EventArgs e)
        {

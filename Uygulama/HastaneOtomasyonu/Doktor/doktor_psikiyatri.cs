...
{
    public partial class doktor_psikiyatri : Form
    {

        public doktor_psikiyatri()
        {
            InitializeComponent();
        }
        ...
        private void doktorgel()
        {
            ...
            komut.Parameters.AddWithValue("@bolum", 8);
        ...
        private void doktor_psikiyatri_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            doktor_psikiyatri_gh dgh = new doktor_psikiyatri_gh();
            dgh.Show();
        }

...
{
    public partial class doktor_goz : Form
    {
        ...
        private void doktorgel()
        {
            ...
            komut.Parameters.AddWithValue("@bolum", 11);
        ...
        private void doktor_goz_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            doktor_goz_gh dgh = new doktor_goz_gh();
            dgh.Show();
        }

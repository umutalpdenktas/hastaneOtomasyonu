...
{
    public partial class doktor_kardiyoloji : Form
    {

        public doktor_kardiyoloji()
        {
            InitializeComponent();
        }
        ...
        private void doktorgel()
        {
            ...
            komut.Parameters.AddWithValue("@bolum", 2);
        ...
        private void doktor_kardiyoloji_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            doktor_kardiyoloji_gh dgh = new doktor_kardiyoloji_gh();
            dgh.Show();
        }

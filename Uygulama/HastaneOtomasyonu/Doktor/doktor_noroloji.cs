...
{
    public partial class doktor_noroloji : Form
    {

        public doktor_noroloji()
        {
            InitializeComponent();
        }
        ...
        private void doktorgel()
        {
            ...
            komut.Parameters.AddWithValue("@bolum", 1);
        ...
        private void doktor_noroloji_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            doktor_noroloji_gh dgh = new doktor_noroloji_gh();
            dgh.Show();
        }

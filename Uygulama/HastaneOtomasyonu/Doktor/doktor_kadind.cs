...
{
    public partial class doktor_kadind : Form
    {

        public doktor_kadind()
        {
            InitializeComponent();
        }
        ...
        private void doktor_kadind_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            doktor_kadind_gh dgh = new doktor_kadind_gh();
            dgh.Show();
        }

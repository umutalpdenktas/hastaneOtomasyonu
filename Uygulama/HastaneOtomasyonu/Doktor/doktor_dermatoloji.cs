...
{
    public partial class doktor_dermatoloji : Form
    {

        public doktor_dermatoloji()
        {
            InitializeComponent();
        }
        ...
        private void doktorgel()
        {
            ...
            komut.Parameters.AddWithValue("@bolum", 9);
        ...
        private void doktor_dermatoloji_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            doktor_dermatoloji_gh dgh = new doktor_dermatoloji_gh();
            dgh.Show();
        }

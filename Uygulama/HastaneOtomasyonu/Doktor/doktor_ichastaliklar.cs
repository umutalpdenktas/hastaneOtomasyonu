...
{
    public partial class doktor_ichastaliklar : Form
    {

        public doktor_ichastaliklar()
        {
            InitializeComponent();
        }
        ...
        private void doktor_ichastaliklar_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            doktor_ichastaliklar_gh dgh = new doktor_ichastaliklar_gh();
            dgh.Show();
        }

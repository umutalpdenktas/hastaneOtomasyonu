...
{
    public partial class doktor_ortopedi : Form
    {

        public doktor_ortopedi()
        {
            InitializeComponent();
        }
        ...
        private void doktorgel()
        {
            ...
            komut.Parameters.AddWithValue("@bolum", 3);
        ...
        private void doktor_ortopedi_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            doktor_ortopedi_gh dgh = new doktor_ortopedi_gh();
            dgh.Show();
        }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    baglanti.Open();
                    komut = new SqlCommand("UPDATE radyoloji_sonuclar SET hasta_adsoyad=@soyad,radyoloji_tetkikler_id = @rkodu,radyoloji_tetkik_adi=@radkod,sonuc=1 WHERE hasta_id=@hasta_id", baglanti);
                    komut.Parameters.AddWithValue("@hasta_id", textBox1.Text);
                    komut.Parameters.AddWithValue("@adsoyad", dataGridView1.CurrentRow.Cells[1].Value.ToString() + " " + dataGridView1.CurrentRow.Cells[2].Value.ToString());
        ...
        {
            doktor_mail dm = new doktor_mail();
            dm.Show();
        }
